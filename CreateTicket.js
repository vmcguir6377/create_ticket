...
function ShowCreateTicket() {
 this.ShowCreateTicketPopup =  $('<div/>').appendTo('body')
 .dxPopup({
   title: 'Create Ticket',
   visible: true,
   onHidden:(e)=> {
    e.component.dispose(); e.element().remove();
   },
   ...
   contentTemplate: (container) => {
     ...
     this.scrollView.append(formView);
     ...
     this.container.append(scrollView);
   },
