 CreateTicket = class {
  constructor() {
    this.CreateTicketPopup = null;
    this.ShowCreateTicket()
  }
  ShowCreateTicket() {
    if(this.CreateTicketPopup !==null){
      this.CreateTicketPopup.hide();
      this.ShowCreateTicket();
      return;
    }
   this.CreateTicketPopup =  $('<div>').appendTo('body')
    .dxPopup({
      title: 'Create Ticket',
      visible: true,
    ...
    //Initializing
    $(() => {
     _CreateTicketPopup = new CreateTicket();
    }
    )
